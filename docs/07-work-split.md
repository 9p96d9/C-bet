...
| ドメイン `03-domains` | 全10ハブ＋**サブ記事15本**（gross-motor・fine-motor・social-emotional・language・literacy は各2本、他は各1本） | 各ドメインへサブ記事をさらに追加（`content/03-domains/<domain>/<slug>.md` を置くだけ。→ schema 02 の `domain-article`） |
