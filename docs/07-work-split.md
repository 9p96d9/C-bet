...
| セクション | 現状 | 次の目標 |
|---|---|---|
| 科学 `01-science` | **20章**（きょうだい/出生順・昼寝・叱りの科学・気質を追加） | +（遊びの発達段階 等、随時） |
...
| 神話 `07-myths` | **30枚**（早生まれ・性格ラベリング・二言語混乱・歩行の早さ・泣かせる神話・スクリーンと近視を追加） | +（随時） |
| 付録 `09-appendix` | 用語47/文献27 | 各コンテンツ増加に合わせ随時追記 |
