...
## 現状スナップショット（2026-07-10 / 204ページ・警告ゼロ・リンク切れゼロ）
...
| ドメイン `03-domains` | 全10ハブ＋**サブ記事9本**（language ×2・executive-function ×1・gross-motor/tummy-time・math-spatial/number-sense・social-emotional/emotion-coaching・fine-motor/pincer-grip・literacy/dialogic-reading・play/open-ended-play） | サブ記事を各ドメインにさらに増築（`content/03-domains/<domain>/<slug>.md` を置くだけ。→ schema 02 の `domain-article`）。残り：music・sensory ハブへのサブ記事 |
